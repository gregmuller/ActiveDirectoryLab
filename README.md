...
<br />
<br />
Go into "mydomain.com". Select "New" and "Organizational Unit". Label the folder _ADMINS and uncheck "Protect container from accidental deletion" and create a new user. User Login name should be a-gmuller:  <br/>
